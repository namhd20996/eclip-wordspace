...
//		lbl_forgotPw.addMouseListener(ctl);
		...
		lblNewLabel_3_3_1.setIcon(new ImageIcon(
				TaoTaiKhoanJDialog.class.getResource("/IMG_JavaIcon/Actions-contact-new-icon (3) - Copy.png")));
		...
		lblNewLabel_3_3_2.setIcon(
				new ImageIcon(TaoTaiKhoanJDialog.class.getResource("/IMG_JavaIcon/Christmas-Island-icon (3).png")));
	...
	public void registerUser() {
		...
		UserModel userM = new UserModel(user, MaHoa.toSHA1(passWord), role, email);
		if(UserDao.getInstance().insert(userM)>0) {
