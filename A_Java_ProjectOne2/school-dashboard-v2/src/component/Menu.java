...
public class Menu extends javax.swing.JPanel {
	...
	public Menu() {
		...
		scrollPane.setBounds(0, 107, 177, 474);
...
//		System.out.println(pnlMenu.getComponentCount());
	...
	public void initMenuItem() {
		...
		addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/1.png")), "Phòng", "Quản lý phòng",
				"Chuyển phòng", "Lịch sử thuê"));
		addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/2.png")), "Dịch vụ",
				"Danh sách dịch vụ", "Tạo dịch vụ"));
		addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/3.png")), "Phiếu thu",
				"Phiếu thu tiền phòng", "Phiếu thu dịch vụ"));
		addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/4.png")), "Tính tiền",
				"Tiền tiền phòng"));
		addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/5.png")), "Phiếu chi",
				"Quản lý phiếu chi"));
		...
		addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/10.png")), "Tài sản",
				"Danh sách tài sản"));
		addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/com/raven/icon/10.png")), "Phạt/K.thưởng",
				"Quản lý PP-KT"));
	}
