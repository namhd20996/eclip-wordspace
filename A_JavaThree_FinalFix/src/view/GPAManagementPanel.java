...
public class GPAManagementPanel extends JPanel {
	...
	public GPAManagementPanel() {
		...
		textField_MaSinhVienFind.setHorizontalAlignment(SwingConstants.CENTER);
		textField_MaSinhVienFind.setBorder(new MatteBorder(0, 0, 2, 1, (Color) new Color(255, 0, 0)));
...
//		textField_MaSinhVien.addFocusListener(ctl);
		...
		textField_HoTen.setBackground(new Color(255, 255, 255));
		...
		textField_TiengAnh.setHorizontalAlignment(SwingConstants.CENTER);
		textField_TiengAnh.setBorder(new MatteBorder(0, 0, 2, 1, (Color) new Color(0, 255, 0)));
		...
		textField_TinHoc.setHorizontalAlignment(SwingConstants.CENTER);
		textField_TinHoc.setBorder(new MatteBorder(0, 0, 2, 1, (Color) new Color(0, 255, 0)));
		...
		textField_GDTC.setHorizontalAlignment(SwingConstants.CENTER);
		textField_GDTC.setBorder(new MatteBorder(0, 0, 2, 1, (Color) new Color(0, 128, 255)));
