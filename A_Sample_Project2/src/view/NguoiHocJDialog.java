...
//				this.loadDataTable();
			...
			NguoiHocModel nhm = new NguoiHocModel();
			nhm.setMaNguoiHoc(maNH);
			NguoiHocModel nh = NguoiHocDAO.getInstance().selectByID(nhm);
			if (nh != null) {
				model_table.setRowCount(0);
				model_table.addRow(new Object[] { nh.getMaNguoiHoc(), nh.getTenNguoiHoc(),
						XDate.dateString(nh.getNgaySinh()), (nh.isGioiTinh() ? "Nam" : "Nữ"), nh.getDienThoai(),
				...
				MsgBox.showErrorDialog(this, "Not found", "Error");
			}
		} catch (Exception e) {
