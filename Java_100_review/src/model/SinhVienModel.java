...
public class SinhVienModel implements Serializable{
	...
	public SinhVienModel(int maSinhVien, String tenSinhVien, Tinh queQuan, Date ngaySinh, boolean gioiTinh,
	...
	public String toString() {
		return "SinhVienModel [maSinhVien=" + maSinhVien + ", tenSinhVien=" + tenSinhVien + ", queQuan=" + queQuan
